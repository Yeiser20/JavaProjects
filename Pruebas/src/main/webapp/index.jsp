...
<body>
	<div class="container col-lg-3">
		...
		<p><strong>Bienvenidos a viancoLab</strong></p>
			
	<div class="from-group">
		<label>Nombres:</label>
		<input class="form-control" type="text" name="txtxnom" placeholder="Ingrese su nombre">
	</div>
	
	<div class="form-group">
		<label>Email:</label>
		<input type="text" name="txtCorreo" placeholder="example@gmail.com" class="form-control">
