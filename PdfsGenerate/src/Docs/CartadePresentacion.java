...
public class CartadePresentacion {
    ...
    public void crearPdf() throws FileNotFoundException, IOException,BadElementException {
    	...
    	try {
    	String ruta="C:\\Users\\danie\\OneDrive\\Documentos\\NetbeansProjects\\PdfGenerate\\Documento1.pdf"; 
		...
		p10.add("Toluca, Estado de México a "+ dia +" de" + anio+"\n\n");
        doc.add(p10);
